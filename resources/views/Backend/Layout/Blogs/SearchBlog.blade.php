        ...
        <div class="table-wrapper table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <div class="action" >
                        <a style="width: 50%" href="{{ route('blog.delete', $blog->id) }}" class="text-danger">
                        <i class="lni lni-trash-can"></i>
                        </a>

                        <a style="font-size: 13px" href="{{ route('blog.edit', $blog->id) }}" class="text-danger">
